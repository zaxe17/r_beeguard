	...
	return (
		<div className="flex flex-col gap-10">
			...
			<div
				...
				{/* LEFT */}
				<div className="bg-[#ffdb4f]/20 flex justify-center items-center p-10 rounded-md border border-[#ffdb4f]">
					<div className="w-20 h-20 rounded-full bg-[#ffdb4f]/30 flex justify-center items-center p-2">
						<Image
							src={HiveIcon["weak"].icon}
							alt="hive_icon"
				...
				<div className="w-full">
					...
					<div className="flex justify-between items-center mt-5">
						...
						<div className="flex flex-col">
							...
							<span className="Poppins-SemiBold text-sm text-[#ffdb4f]">
								weak
							</span>
						</div>
					</div>
			...
			<div className="flex flex-col items-center justify-center gap-5">
				<div className="w-full flex items-center justify-center gap-3">
					<Button label="Monitor Hive Health" />
					<Button label="Add Yield" />
				</div>
				<span className="Poppins-SemiBold cursor-pointer underline text-[#817b70]">View Yield History</span>
			</div>
		</div>
	);
};
